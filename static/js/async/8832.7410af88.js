/*! For license information please see 8832.7410af88.js.LICENSE.txt */
"use strict";(self.webpackChunkmonaco_ts=self.webpackChunkmonaco_ts||[]).push([["8832"],{40147:function(e,t,a){a.r(t),a.d(t,{conf:function(){return r},language:function(){return _}});var r={comments:{lineComment:"//",blockComment:["/*","*/"]},brackets:[["{","}"],["[","]"],["(",")"]],autoClosingPairs:[{open:"[",close:"]"},{open:"{",close:"}"},{open:"(",close:")"}],surroundingPairs:[{open:"{",close:"}"},{open:"[",close:"]"},{open:"(",close:")"}]};function o(e){let t=[],a=e.split(/\t+|\r+|\n+| +/);for(let e=0;e<a.length;++e)a[e].length>0&&t.push(a[e]);return t}var n=o("true false"),i=o(`
			  alias
			  break
			  case
			  const
